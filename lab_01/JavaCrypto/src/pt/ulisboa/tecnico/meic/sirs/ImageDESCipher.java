...
/**
 * Encrypts an image with the DES algorithm in multiple modes, with a given, 
 * appropriate DES key.
 */
public class ImageDESCipher {
    ...
    public static void main(String[] args) throws IOException {
        ...
        if(args.length != 4) {
            ...
            System.err.println("Usage: ImageDESCipher [inputFile.png] [DES] [ECB|CBC|OFB] [outputFile.png]");
            return;
        }
